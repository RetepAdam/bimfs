...
def scrape_cbb_single_page(year, page):
    ...
    if table:
        ...
        conf = ['A-10', 'AAC', 'ACC', 'AEC', 'A-Sun', 'Big', 'CAA', 'CUSA', 'GWC', 'Horizon', 'Ind', 'Ivy', 'MAAC', 'MAC', 'MEAC', 'Mid-Cont', 'MVC', 'MWC', 'NEC', 'OVC', 'Pac-10', 'Pac-12', 'Patriot', 'SEC', 'Southland', 'Summit', 'Sun', 'SWAC', 'WAC', 'WCC']
...
def scrape_cbb_all_years():
    ...
    for year in years:
        ...
        df = df.append(df2, ignore_index=True)
    df.to_csv('data/cbb_2010_to_2017.csv', index=False)
