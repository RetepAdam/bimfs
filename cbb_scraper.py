...
def scrape_cbb_single_page(year, page):
    ...
    conf = ['A-10', 'AAC', 'ACC', 'AEC', 'A-Sun', 'Big', 'CAA', 'CUSA', 'GWC', 'Horizon', 'Ind', 'Ivy', 'MAAC', 'MAC', 'MEAC', 'MVC', 'MWC', 'NEC', 'OVC', 'Pac-12', 'Patriot', 'SEC', 'Southland', 'Summit', 'Sun', 'SWAC', 'WAC', 'WCC']
